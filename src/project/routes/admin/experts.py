...
from ...models.helpers import Industry, Country
...
from ...utils.enums import NotificationType, QualificationType, StatusType, Status
...
@experts.route("/create", methods=["GET", "POST"])
@admin_only
def create_expert():
    if request.method == "GET":
        ...
        expert = Expert(
            ...
            website=add_https_prefix(website) if website else None,
