...
class Documents(object):
    ...
    def create(self, document: Dict[str, Any], params: Optional[Dict[str, Any]] = None) -> Dict[str, Any]: ...
    def create_many(
        self, documents: List[Dict[str, Any]], params: Optional[Dict[str, Any]] = None
    ) -> Dict[str, Any]: ...
    def upsert(self, document: Dict[str, Any], params: Optional[Dict[str, Any]] = None) -> Dict[str, Any]: ...
    def update(self, document: Dict[str, Any], params: Optional[Dict[str, Any]] = None) -> Dict[str, Any]: ...
