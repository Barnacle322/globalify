...
def test_settings_authenticated_unverified_get(client, unverified_user, app, monkeypatch):
...
def test_settings_authenticated_get(client, verified_user, app, monkeypatch):
    app.config["SERVER_NAME"] = "localhost"
    app.config["APPLICATION_ROOT"] = ""
    app.config["PREFERRED_URL_SCHEME"] = "http"
    with app.app_context():
...
def test_settings_security_authenticated_unverified_get(client, unverified_user, app, monkeypatch):
    app.config["SERVER_NAME"] = "localhost"
    app.config["APPLICATION_ROOT"] = ""
    app.config["PREFERRED_URL_SCHEME"] = "http"
    with app.app_context():
...
def test_settings_security_authenticated_get(client, verified_user, app, monkeypatch):
    app.config["SERVER_NAME"] = "localhost"
    app.config["APPLICATION_ROOT"] = ""
    app.config["PREFERRED_URL_SCHEME"] = "http"
    with app.app_context():
...
def test_settings_plan_authenticated_unverified_get(client, unverified_user, app, monkeypatch):
    app.config["SERVER_NAME"] = "localhost"
    app.config["APPLICATION_ROOT"] = ""
    app.config["PREFERRED_URL_SCHEME"] = "http"
    with app.app_context():
...
def test_settings_plan_authenticated_get(client, verified_user, app, monkeypatch):
    app.config["SERVER_NAME"] = "localhost"
    app.config["APPLICATION_ROOT"] = ""
    app.config["PREFERRED_URL_SCHEME"] = "http"
    with app.app_context():
...
def test_settings_billing_authenticated_unverified_get(client, unverified_user, app, monkeypatch):
...
def test_settings_billing_authenticated_get(client, verified_user, app, monkeypatch):
    with patch("stripe.Invoice.list") as mock_invoice_list:
        mock_invoice_list.return_value = [
            {
                "id": "invoice_123",
...
def test_settings_change_personal_info(client, verified_user, app, monkeypatch):
    app.config["SERVER_NAME"] = "localhost"
    app.config["APPLICATION_ROOT"] = ""
    app.config["PREFERRED_URL_SCHEME"] = "http"
    with app.app_context():
...
def test_change_personal_info_empty_last_name(client, verified_user, app, monkeypatch):
    app.config["SERVER_NAME"] = "localhost"
    app.config["APPLICATION_ROOT"] = ""
    app.config["PREFERRED_URL_SCHEME"] = "http"
    with app.app_context():
...
def test_change_personal_info_empty_bio(client, verified_user, app, monkeypatch):
    app.config["SERVER_NAME"] = "localhost"
    app.config["APPLICATION_ROOT"] = ""
    app.config["PREFERRED_URL_SCHEME"] = "http"
    with app.app_context():
...
def test_change_personal_info_empty_username(client, verified_user, app, monkeypatch):
    app.config["SERVER_NAME"] = "localhost"
    app.config["APPLICATION_ROOT"] = ""
    app.config["PREFERRED_URL_SCHEME"] = "http"
    with app.app_context():
...
def test_change_personal_info_taken_username(client, verified_user, username_taken_user, app, monkeypatch):
    app.config["SERVER_NAME"] = "localhost"
    app.config["APPLICATION_ROOT"] = ""
    app.config["PREFERRED_URL_SCHEME"] = "http"
    with app.app_context():
...
def test_settings_company_authenticated_get(client, new_user_with_company, app, monkeypatch):
    app.config["SERVER_NAME"] = "localhost"
    app.config["APPLICATION_ROOT"] = ""
    app.config["PREFERRED_URL_SCHEME"] = "http"
    with app.app_context():
...
def test_settings_company_authenticated_without_company_get(client, verified_user, app, monkeypatch):
    app.config["SERVER_NAME"] = "localhost"
    app.config["APPLICATION_ROOT"] = ""
    app.config["PREFERRED_URL_SCHEME"] = "http"
    with app.app_context():
...
def test_change_company_empty_name(client, new_user_with_company, app, monkeypatch):
    app.config["SERVER_NAME"] = "localhost"
    app.config["APPLICATION_ROOT"] = ""
    app.config["PREFERRED_URL_SCHEME"] = "http"
    with app.app_context():
...
def test_change_company_empty_industry_and_round(client, new_user_with_company, app, monkeypatch):
    app.config["SERVER_NAME"] = "localhost"
    app.config["APPLICATION_ROOT"] = ""
    app.config["PREFERRED_URL_SCHEME"] = "http"
    with app.app_context():
...
def test_change_company_empty_country(client, new_user_with_company, app, monkeypatch):
    app.config["SERVER_NAME"] = "localhost"
    app.config["APPLICATION_ROOT"] = ""
    app.config["PREFERRED_URL_SCHEME"] = "http"
    with app.app_context():
...
def test_change_company_valid_data(client, new_user_with_company, app, monkeypatch):
    app.config["SERVER_NAME"] = "localhost"
    app.config["APPLICATION_ROOT"] = ""
    app.config["PREFERRED_URL_SCHEME"] = "http"
    with app.app_context():
